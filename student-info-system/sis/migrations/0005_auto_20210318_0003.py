# Generated by Django 3.1.7 on 2021-03-18 00:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='semester',
            name='semester',
            field=models.CharField(choices=[('FA', 'Fall'), ('SP', 'Spring'), ('SU', 'Summer'), ('WI', 'Winter')], default='FA', max_length=6, verbose_name='semester'),
        ),
        migrations.AddField(
            model_name='semester',
            name='year',
