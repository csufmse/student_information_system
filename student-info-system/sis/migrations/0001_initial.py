    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_type', models.CharField(choices=[('months', 'months'), ('weeks', 'weeks'), ('days', 'days'), ('hours', 'hours'), ('minutes', 'minutes'), ('seconds', 'seconds')], max_length=7, verbose_name='Interval Type')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
