# Generated by Django 3.1.7 on 2021-04-24 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_type', models.CharField(choices=[('hours', 'hours'), ('minutes', 'minutes'), ('days', 'days'), ('months', 'months'), ('seconds', 'seconds'), ('weeks', 'weeks')], max_length=7, verbose_name='Interval Type')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency_type', models.CharField(choices=[('interval', 'interval'), ('immediate', 'immediate'), ('date', 'date')], max_length=9, verbose_name='Frequency Type')),
