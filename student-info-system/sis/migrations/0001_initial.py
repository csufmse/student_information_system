    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_type', models.CharField(choices=[('seconds', 'seconds'), ('minutes', 'minutes'), ('days', 'days'), ('months', 'months'), ('weeks', 'weeks'), ('hours', 'hours')], max_length=7, verbose_name='Interval Type')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[('generic', 'generic'), ('probation', 'probation'), ('droprequest', 'droprequest'), ('majorchange', 'majorchange'), ('sectionfilling', 'sectionfilling'), ('sectionfull', 'sectionfull'), ('sectionadded', 'sectionadded')], default='generic', max_length=15)),
                ...
                ('support_data', models.JSONField(default=dict, max_length=1024)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency_type', models.CharField(choices=[('date', 'date'), ('immediate', 'immediate'), ('interval', 'interval')], max_length=9, verbose_name='Frequency Type')),
