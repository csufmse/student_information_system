# Generated by Django 3.1.7 on 2021-04-12 01:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[('generic', 'generic'), ('probation', 'probation'), ('droprequest', 'droprequest'), ('majorchange', 'majorchange')], default='generic', max_length=15)),
                ...
                ('support_data', models.JSONField(blank=True, max_length=1024, null=True)),
