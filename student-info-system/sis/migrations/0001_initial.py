    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_type', models.CharField(choices=[('minutes', 'minutes'), ('months', 'months'), ('days', 'days'), ('seconds', 'seconds'), ('weeks', 'weeks'), ('hours', 'hours')], max_length=7, verbose_name='Interval Type')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
