    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_type', models.CharField(choices=[('weeks', 'weeks'), ('days', 'days'), ('seconds', 'seconds'), ('hours', 'hours'), ('months', 'months'), ('minutes', 'minutes')], max_length=7, verbose_name='Interval Type')),
            ],
        ),
        migrations.CreateModel(
            name='Major',
