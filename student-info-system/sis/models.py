...
class Person(models.Model):
    ...
    address = models.CharField('Address',max_length=256, help_text='Your Mailing Address', blank=True)
    email = models.EmailField(help_text='Your Primary Email Address', unique=True)
