...
# need to verify this is a login page. It's 200.
# def test_home_view_redirects_for_loser(self):
#     login = self.client.login(username='testuser1', password='1X<23fwd+tuK')
#     response = self.client.get('/schooladmin/')
#     self.assertEqual(response.status_code, 302)
...
class AdminViewsTest(TestCase):
    ...
    def test_major_view_exists(self):
        login = self.client.login(username='testuser1', password='1X<23fwd+tuK')
        response = self.client.get('/schooladmin/major/1')
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_major_view_exists(self):
        login = self.client.login(username='testuser1', password='1X<23fwd+tuK')
        response = self.client.get('/schooladmin/major/1/edit')
        self.assertEqual(response.status_code, 200)
