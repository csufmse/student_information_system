...
class MessageTable(tables.Table):
    ...
    time_read = ClassyDateTimeColumn(verbose_name="Read at", css_class_base='message_date', format='Y-m-d H:i' )
    time_sent = ClassyDateTimeColumn(verbose_name="Sent at", css_class_base='message_date', format='Y-m-d H:i' )
    ...
    class Meta:
        ...
        row_attrs = {'class': (lambda record: 'message_row unread' if record.unread else 'message_row'),
...
class MessageReceivedTable(MessageTable):
    class Meta:
        ...
        row_attrs = {'class': (lambda record: classes_for(record)),
                    'data-id': lambda record: record.pk}
