...
from sis.tables.users import (UsersTable, FullUsersTable, StudentsTable,
...
def students(request):
    ...
    return render(
        request, 'schooladmin/students.html',data)
...
def semesters(request):
    ...
    return render(
        request, 'schooladmin/semesters.html', data)
